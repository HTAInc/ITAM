...
interface EditProps {
    manufacture: ManufactureProps,
}

export default function Edit({manufacture}: EditProps) {
    const { data, setData, post, processing, errors } = useForm({
        name: manufacture.name,
        url: manufacture.url,
        support_url: manufacture.support_url,
        support_phone: manufacture.support_phone,
        support_email: manufacture.support_email,
        image: manufacture.image || null,
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.post(route("auth.manufacture.update", manufacture.id), {
                    _method: "PUT",
                    ...data,
                });
            }
        ...
        <Guest>
            <div className="flex w-full justify-center pt-10">
                <form onSubmit={submit} className="w-1/3 rounded-xl">
                    <Card className="">
                        <CardHeader>
                            <CardTitle>Edit Manufacture : {manufacture.name}</CardTitle>
