...
export default function Edit({user,companies,departments,sections,roles}: CreateProps) {
    const { data, setData, put, processing, errors,reset } = useForm({
        company_id: user.section.department.company_id,
        department_id: user.section.department_id,
    ...
    const submit: FormEventHandler = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                put(route("auth.user.update", user.id));
            }
        });
    };
    return (
