...
class CreateUserNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Account Registration for ITAM Application - No Reply')
            ->greeting('Dear '. $this->user->name)
            ->line('We are pleased to inform you that your account for the ITAM application has been successfully registered.')
