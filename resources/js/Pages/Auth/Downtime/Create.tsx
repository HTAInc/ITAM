...
export default function Create() {
    ...
    const downtimeOptions = DOWNTIME_CATEGORIES_DATA.map((item: CategoryProps) => ({
        value:item.value,
        label:item.label,
    }))
    ...
    const submit: FormEventHandler = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                post(route('auth.downtime.store'));
            }
        });
        ...
        <Guest>
            <div className="flex w-full justify-center pt-10">
                <form onSubmit={submit} className="w-1/3 rounded-xl">
                    <Card className="">
                        <CardHeader>
                            <CardTitle>Create Downtime</CardTitle>
                        ...
                        <CardContent>   
                            <div className="mb-3">
                                ...
                                <Select
                                    ...
                                    value={downtimeOptions.find(option => option.value === data.category)}
